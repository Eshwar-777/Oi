...
function resolveAnthropicDefaultAuthMode(cfg: RuntimeConfig): AnthropicAuthDefaultsMode | null {
...
export function applyMessageDefaults(cfg: RuntimeConfig): RuntimeConfig {
...
export function applyTalkApiKey(config: RuntimeConfig): RuntimeConfig {
...
export function applyTalkConfigNormalization(config: RuntimeConfig): RuntimeConfig {
  return normalizeTalkConfig(config);
}

export function applyModelDefaults(cfg: RuntimeConfig): RuntimeConfig {
  let mutated = false;
  let nextCfg = cfg;
...
export function applyAgentDefaults(cfg: RuntimeConfig): RuntimeConfig {
...
export function applyLoggingDefaults(cfg: RuntimeConfig): RuntimeConfig {
...
export function applyContextPruningDefaults(cfg: RuntimeConfig): RuntimeConfig {
...
export function applyCompactionDefaults(cfg: RuntimeConfig): RuntimeConfig {
  const defaults = cfg.agents?.defaults;
  if (!defaults) {
    return cfg;
  }
