...
function pickMaxBytes(cfg?: RuntimeConfig, maxBytesMb?: number): number | undefined {
...
async function runImagePrompt(params: {
  ...
  await ensureRuntimeModelsJson(effectiveCfg, params.agentDir);
