...
function resolveAvatarSource(cfg: RuntimeConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: RuntimeConfig, agentId: string): AgentAvatarResolution {
