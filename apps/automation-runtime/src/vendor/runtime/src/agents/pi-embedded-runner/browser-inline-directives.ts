export type BrowserInlineDirectiveParseResult = {
  text: string;
...
type BrowserInlineDirectiveParseOptions = {
...
export function parseBrowserInlineDirectives(
  text?: string,
  options: BrowserInlineDirectiveParseOptions = {},
): BrowserInlineDirectiveParseResult {
