...
type ModelsConfig = NonNullable<RuntimeConfig["models"]>;
...
export function normalizeGoogleModelId(id: string): string {
  ...
  // Preserve compatibility with earlier Runtime docs/config that pointed at a
...
export async function resolveImplicitCopilotProvider(params: {
  ...
  // Runtime keeps auth in auth-profiles and resolves runtime availability from that store.
