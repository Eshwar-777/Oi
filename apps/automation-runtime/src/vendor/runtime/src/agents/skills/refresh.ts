...
function resolveWatchPaths(workspaceDir: string, config?: RuntimeConfig): string[] {
  const paths: string[] = [];
...
function resolveWatchTargets(workspaceDir: string, config?: RuntimeConfig): string[] {
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: RuntimeConfig }) {
