...
export function listAgentEntries(cfg: RuntimeConfig): AgentEntry[] {
...
export function listAgentIds(cfg: RuntimeConfig): string[] {
...
export function resolveDefaultAgentId(cfg: RuntimeConfig): string {
  const agents = listAgentEntries(cfg);
  if (agents.length === 0) {
    return DEFAULT_AGENT_ID;
  }
...
export function resolveAgentModelPrimary(cfg: RuntimeConfig, agentId: string): string | undefined {
...
export function resolveAgentWorkspaceDir(cfg: RuntimeConfig, agentId: string) {
  const id = normalizeAgentId(agentId);
...
export function resolveAgentDir(cfg: RuntimeConfig, agentId: string) {
  const id = normalizeAgentId(agentId);
