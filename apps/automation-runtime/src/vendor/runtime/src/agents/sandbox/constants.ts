...
export const DEFAULT_SANDBOX_IMAGE = "runtime-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "runtime-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "runtime-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "runtime-sandbox-common:bookworm-slim";
export const SANDBOX_BROWSER_SECURITY_HASH_EPOCH = "2026-02-28-no-sandbox-env";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "runtime-sbx-browser-";
export const DEFAULT_SANDBOX_BROWSER_NETWORK = "runtime-sandbox-browser";
