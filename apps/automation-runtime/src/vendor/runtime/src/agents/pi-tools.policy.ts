...
export function resolveSubagentToolPolicy(cfg?: RuntimeConfig, depth?: number): SandboxToolPolicy {
...
function resolveExplicitProfileAlsoAllow(tools?: RuntimeConfig["tools"]): string[] | undefined {
...
function resolveImplicitProfileAlsoAllow(params: {
  globalTools?: RuntimeConfig["tools"];
