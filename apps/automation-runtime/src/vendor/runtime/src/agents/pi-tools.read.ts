...
function resolveAdaptiveReadMaxBytes(options?: RuntimeReadToolOptions): number {
...
export function createSandboxedReadTool(params: SandboxToolParams) {
  ...
  return createRuntimeReadTool(base, {
...
export function createRuntimeReadTool(
  base: AnyAgentTool,
  options?: RuntimeReadToolOptions,
): AnyAgentTool {
