import type { RuntimeConfig, HumanDelayConfig, IdentityConfig } from "../config/config.js";
...
export function resolveIdentityName(cfg: RuntimeConfig, agentId: string): string | undefined {
...
export function resolveMessagePrefix(
  ...
  return resolveIdentityNamePrefix(cfg, agentId) ?? opts?.fallback ?? "[runtime]";
}
