...
const CLEANUP_STATE_KEY = Symbol.for("runtime.sessionWriteLockCleanupState");
const HELD_LOCKS_KEY = Symbol.for("runtime.sessionWriteLockHeldLocks");
const WATCHDOG_STATE_KEY = Symbol.for("runtime.sessionWriteLockWatchdogState");
