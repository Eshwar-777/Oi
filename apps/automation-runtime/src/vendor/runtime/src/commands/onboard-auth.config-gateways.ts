...
export function applyVercelAiGatewayProviderConfig(cfg: RuntimeConfig): RuntimeConfig {
...
export function applyVercelAiGatewayConfig(cfg: RuntimeConfig): RuntimeConfig {
