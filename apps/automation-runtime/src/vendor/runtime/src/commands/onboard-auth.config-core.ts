...
export function applyOpenrouterProviderConfig(cfg: RuntimeConfig): RuntimeConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyOpenrouterConfig(cfg: RuntimeConfig): RuntimeConfig {
  const next = applyOpenrouterProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, OPENROUTER_DEFAULT_MODEL_REF);
}

export function applyMoonshotProviderConfig(cfg: RuntimeConfig): RuntimeConfig {
  return applyMoonshotProviderConfigWithBaseUrl(cfg, MOONSHOT_BASE_URL);
}

export function applyMoonshotProviderConfigCn(cfg: RuntimeConfig): RuntimeConfig {
...
export function applyMoonshotConfig(cfg: RuntimeConfig): RuntimeConfig {
  const next = applyMoonshotProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyMoonshotConfigCn(cfg: RuntimeConfig): RuntimeConfig {
  const next = applyMoonshotProviderConfigCn(cfg);
  return applyAgentDefaultModelPrimary(next, MOONSHOT_DEFAULT_MODEL_REF);
}

export function applyKimiCodeProviderConfig(cfg: RuntimeConfig): RuntimeConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyKimiCodeConfig(cfg: RuntimeConfig): RuntimeConfig {
  const next = applyKimiCodeProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, KIMI_CODING_MODEL_REF);
}

export function applySyntheticProviderConfig(cfg: RuntimeConfig): RuntimeConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applySyntheticConfig(cfg: RuntimeConfig): RuntimeConfig {
  const next = applySyntheticProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, SYNTHETIC_DEFAULT_MODEL_REF);
}

export function applyXiaomiProviderConfig(cfg: RuntimeConfig): RuntimeConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXiaomiConfig(cfg: RuntimeConfig): RuntimeConfig {
 ...
 */
export function applyVeniceProviderConfig(cfg: RuntimeConfig): RuntimeConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyVeniceConfig(cfg: RuntimeConfig): RuntimeConfig {
 ...
 */
export function applyTogetherProviderConfig(cfg: RuntimeConfig): RuntimeConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyTogetherConfig(cfg: RuntimeConfig): RuntimeConfig {
 ...
 */
export function applyHuggingfaceProviderConfig(cfg: RuntimeConfig): RuntimeConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyHuggingfaceConfig(cfg: RuntimeConfig): RuntimeConfig {
  const next = applyHuggingfaceProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, HUGGINGFACE_DEFAULT_MODEL_REF);
}

export function applyXaiProviderConfig(cfg: RuntimeConfig): RuntimeConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyXaiConfig(cfg: RuntimeConfig): RuntimeConfig {
  const next = applyXaiProviderConfig(cfg);
  return applyAgentDefaultModelPrimary(next, XAI_DEFAULT_MODEL_REF);
}

export function applyMistralProviderConfig(cfg: RuntimeConfig): RuntimeConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyMistralConfig(cfg: RuntimeConfig): RuntimeConfig {
 ...
 */
export function applyKilocodeProviderConfig(cfg: RuntimeConfig): RuntimeConfig {
  const models = { ...cfg.agents?.defaults?.models };
 ...
 */
export function applyKilocodeConfig(cfg: RuntimeConfig): RuntimeConfig {
...
export function applyQianfanProviderConfig(cfg: RuntimeConfig): RuntimeConfig {
  const models = { ...cfg.agents?.defaults?.models };
...
export function applyQianfanConfig(cfg: RuntimeConfig): RuntimeConfig {
