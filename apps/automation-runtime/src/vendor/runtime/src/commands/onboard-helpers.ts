...
export function summarizeExistingConfig(config: RuntimeConfig): string {
  const rows: string[] = [];
...
export function printWizardHeader(runtime: RuntimeEnv) {
  runtime.log("Automation runtime setup wizard");
}
...
export function formatControlUiSshHint(params: {
  ...
  return [
    ...
    authedUrl,
    "Docs:",
    "https://docs.runtime.ai/gateway/remote",
    "https://docs.runtime.ai/web/control-ui",
  ]
    .filter(Boolean)
    .join("\n");
}
