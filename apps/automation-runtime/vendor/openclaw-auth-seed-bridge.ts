...
import { ensureOpenClawModelsJson } from "../src/vendor/openclaw/src/agents/models-config.js";
import { applyAgentDefaultPrimaryModel } from "../src/vendor/openclaw/src/commands/model-default.js";
import { applyAuthProfileConfig } from "../src/vendor/openclaw/src/commands/onboard-auth.config-core.js";
import { setGeminiApiKey } from "../src/vendor/openclaw/src/commands/onboard-auth.credentials.js";
import type { OpenClawConfig } from "../src/vendor/openclaw/src/config/types.js";
...
async function main(): Promise<void> {
  ...
  process.stdout.write(
    `Seeded OpenClaw auth/config for ${modelName ? `${provider}/${modelName}` : provider}\n`,
  );
}
